...
| `data/career-ops.db` | Your SQLite database (source of truth for applications + pipeline) |
| `data/applications.md` | Your application tracker (read-only snapshot; regenerated by `db.mjs export`) |
| `data/pipeline.md` | Your URL inbox (read-only snapshot; regenerated by `db.mjs export`) |
